...
- `REQUIRED`: a minimum safety, privacy, integrity, evidence, authorization, or identity floor that may not be silently weakened. A target project may be stricter.
