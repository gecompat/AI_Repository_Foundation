...
Foundation 1.14.0 was squash-merged by PR #24 as `a52a5c3c0e5c100c06b039318b1e3eecf3263314`; its post-merge Foundation CI run `34145275461` passed. The current `feature/ai-resilience-acceptance` branch implements `WI-0028` with a cross-platform contract/failure matrix and bounded Windows dual-runtime evidence. `WI-0029` remains the final source self-hosting closure.
