...
The Foundation source repository applies `foundation-ai-work/v1` through `.ai/AI_WORK_PROFILE.md` and `.ai/ai-work/profile.json`. This project profile is not transferred and names no required provider or host runtime.
