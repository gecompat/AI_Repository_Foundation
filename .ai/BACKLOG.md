...
| FND-010 | high | in_progress | Persistent artifact identity and legacy-safe identifier adoption | FND-008 | Layered identity policy, Foundation default profile, existing-project `PRESERVE`/`ADOPT_FORWARD`/`MIGRATE_EXPLICIT` modes, manifest/repo-map contract, direct AI transfer behavior, validator/tests, and v1.3 documentation are consistent and CI is green |
