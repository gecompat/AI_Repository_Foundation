...
| WI-0013 | high | in_progress | Semantic Foundation upgrade applicability assessment | WI-0012 | Every feature introduced or materially changed since the installed target version is deterministically included in the upgrade delta, receives exactly one applicability classification, and relevant improvements such as persistent-identity/nomenclature are surfaced with recommendation/decision semantics; feature catalog, transfer rules, guards, tests, and CI are green |
