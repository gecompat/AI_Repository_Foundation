...
| FND-007 | high | in_progress | Separate Foundation and project validation scopes | v1.1 ruleset | Transferred rules and machine-readable metadata define `FOUNDATION_INTEGRITY`, `PROJECT_SEMANTIC`, and `RUNTIME_EMPIRICAL`; Foundation validator declares its scope; local drift is not semantic approval; CI/tests cover the contract |
