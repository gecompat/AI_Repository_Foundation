...
|---|---|---|---|---|---|
| FND-001 | high | in_progress | Validate current transfer/integration model | current candidate | Validator and unit tests pass; CI is green; fresh-agent semantic transfer/continuation is executed |
...
| FND-005 | high | in_progress | Existing-repository semantic merge assistant | FND-001 | Deterministic file plan plus AI protocol classify rule overlaps, preserve active target governance/discovery, and produce bounded reviewable semantic merges |
...
| FND-008 | high | in_progress | Semantic integration compatibility and discovery contract | existing-repository feedback | Compatibility taxonomy, stricter-project compatibility, root discovery invariant, adapter rule preservation, and repo-map preservation are transferred and machine-readable |
| FND-009 | medium | in_progress | Existing policy interoperability | FND-008 | Richer validation statuses, model-routing policies, and narrow provenance/privacy exceptions are preserved through explicit contracts |
