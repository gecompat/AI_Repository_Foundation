...
| WI-0015 | high | blocked | Enforce Foundation GitHub merge protection and target hardening guidance | WI-0014 | Foundation main branch protection is enabled and verified with strict required checks validate and registry-integrity, administrator enforcement, linear history, no force pushes, and no deletion; direct AI transfer and deterministic installation explicitly recommend equivalent GitHub hardening to relevant target projects without making it a FOUNDATION_INTEGRITY requirement. |
