...
Cross-platform evidence: PR #26 head `487471b6155d19edc9d9a0bdd222b00e0cc40b26` passed Foundation CI run `34148146132`, comprising the source-profile integration on macOS and Windows followed by the required complete Linux `validate` gate. Foundation Artifact Registry run `34148145993` also passed. The same head passed the focused 97-test platform selection and all 231 tests locally on Windows.
