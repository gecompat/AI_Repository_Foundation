...
- `AI_REPOSITORY_FOUNDATION_NOTICE.md` carries the required MIT attribution for transferred Foundation material without changing a target repository's root license.
